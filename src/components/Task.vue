<template>
  ...
  <div
    v-if="this.filter == 'all' || this.filter == this.task.status"
    class="
      task
      list__element
      d-flex
  ...
  >
    <div class="content__container" @mouseup="checkAsDone">
      <div :class="this.task.editing ? 'd-none' : ''">
        <p
          :class="
            this.task.status == 'completed' ? 'completed pointer' : 'pointer'
          "
        >
          {{ task.content }}
        </p>
    ...
    <div class="options__container">
      <button @click="copyOption" class="options option__copy">
      ...
      <button @click="deleteOption" class="options option__delete">
...
export default {
  ...
  methods: {
    //launch the copy task event
    copyOption() {
      this.$emit("emitCopy", this.task.content);
    },

    //launch the edit option event
    editOption() {
    ...
    //launch the delete option event
    deleteOption() {
